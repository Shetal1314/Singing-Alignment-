      ...
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              <form name="form1" method="post"  action="editProfileUser.php">
...
$q1= "select * from users where email='$email' and `password`='$passO'";
$res = mysqli_query($con, $q1);
if(mysqli_num_rows($res)>0)
{
	if($passC==$passN)
	{
	$query = "UPDATE users SET `password`='$passN' WHERE `email`='$email'";

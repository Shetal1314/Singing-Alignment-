          ...
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form name="form1" method="post" action="editTask.php">
                ...
                <div class="form-group">
                  <textarea name="des" rows="4" class="form-control form-control-alternative" placeholder="Update Task Description here"></textarea>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    <div class="input-group-prepend">
                ...
                <div class="text-center">
                  <button id="submitBtn" type="submit" class="btn btn-primary mt-4" name="add1" value="Update">Add Task</button>
                </div>
              </form>
            </div>
          </div>

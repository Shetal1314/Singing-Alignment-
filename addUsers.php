...
<body>
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="addUsers.php" style="color: black;">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="dashboard.php">Add User</a>
        <!-- User -->
    ...
    <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
      <div class="container-fluid">
        <div class="header-body">
          <h1 style="color:#fff;text-align:center;">Add user Details Below</h1>
        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" name="form1" method="post"  action="addusers.php" autocomplete="on">
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="ni ni-hat-3"></i></span>
                    </div>
                    <input class="form-control" placeholder="Enter User's Full-Name" name="name" type="text" required>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input class="form-control" name="email" placeholder="Enter User's Email" type="email" autocomplete="off" required>
                  </div>
                </div>
                <div class="form-group" style="margin-bottom: 0px;">
                  <div class="input-group input-group-alternative">
                    ...
                    <input id="password" name="password" class="form-control" placeholder="Enter Password for User" type="password" onKeyUp="checkPasswordStrength();" autocomplete="off" required>
                  </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 0px;">
                  <div class="input-group input-group-alternative">
                    ...
                    <input id="passwordMatch" class="form-control" name="cpassword" placeholder="Confirm Password" type="password" autocomplete="off" onKeyUp="checkPasswordMatch();" required>
                  </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 1.5rem;">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Select User's Date of Birth" name="dob" type="date" autocomplete="off" required>
                  </div>
                </div>
...
$res = mysqli_query($con, $query);
    ...
    $message = $name." is added to the user list";
      echo "<script type='text/javascript'>alert('$message');</script>";

              ...
              <form role="form" name="form1" method="post" action="editExperiment.php" autocomplete="on">
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input class="form-control" name="name" placeholder="Update Experiment Name" type="text" autocomplete="off" required>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input class="form-control" name="subject" placeholder="Update Subject Associated" type="text" autocomplete="off" required>
                  </div>
                </div>

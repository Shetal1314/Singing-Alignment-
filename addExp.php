...
<body>
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="addExp.php" style="color: black;">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="dashboard.php">ADD EXPERIMENTS</a>
        <!-- User -->
    ...
    <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
      <div class="container-fluid">
        <div class="header-body">
          <h1 style="color:#fff;text-align:center;">Add Experimental Details</h1>
        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" name="form1" method="post" action="addExp.php" autocomplete="on">
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="fas fa-list-ol"></i></span>
                    </div>
                    <input class="form-control" placeholder="Enter Experiment Number" name="expID" type="text" required>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input class="form-control" name="name" placeholder="Enter Experiment Name" type="text" autocomplete="off" required>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input class="form-control" name="subject" placeholder="Enter Subject Associated" type="text" autocomplete="off" required>
                  </div>
                </div>
                <select name='tasks[]' id="tasks1" multiple data-placeholder="Select tasks for this experiment ">
                  <?php
                  require("sqlconnection.php");
                ...
                <select name='users[]' id="experiment1" multiple data-placeholder="Select Users for this Experiment ">
                  <?php
                  require("sqlconnection.php");
                ...
                <div class="text-center">
                  <button id="submitBtn" type="submit" class="btn btn-primary mt-4" name="add" value="Add">Add Experiment</button>
                </div>
              </form>
            </div>
          </div>
...
$q1= "SELECT * FROM `experiment1`  WHERE `name`='$name' or experimentID='$expID'";
$res = mysqli_query($con, $q1);
if(mysqli_num_rows($res)>0)
{
$message = "This experiment name or ID already exists, Please try again with a new experiment name or ID";
...
$query ="INSERT INTO `experiment1`(`experimentID`, `name`, `Tasks`, `subject`, `user`) VALUES ('$expID','$name','$task1', '$subject','$user')";
 mysqli_query($con, $query);
//}
}
    $message = $name." is added to the experiment list";
      echo "<script type='text/javascript'>alert('$message');</script>";
